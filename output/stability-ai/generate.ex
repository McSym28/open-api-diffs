defmodule Generate do
  ...
  @type v2beta_stable_image_generate_core_post_400_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }

  @type v2beta_stable_image_generate_core_post_422_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }

  @type v2beta_stable_image_generate_core_post_429_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }

  @type v2beta_stable_image_generate_core_post_500_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }
  ...
  """
  @spec v2beta_stable_image_generate_core_post(map, keyword) ::
          {:ok, map | String.t()} | {:error, map | ContentModerationResponse.t()}
  def v2beta_stable_image_generate_core_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Generate, :v2beta_stable_image_generate_core_post},
      ...
      response: [
        {200,
         {:union,
          [{Generate, :v2beta_stable_image_generate_core_post_200__resp}, string: :generic]}},
        {400, {Generate, :v2beta_stable_image_generate_core_post_400_json_resp}},
        {403, {ContentModerationResponse, :t}},
        {422, {Generate, :v2beta_stable_image_generate_core_post_422_json_resp}},
        {429, {Generate, :v2beta_stable_image_generate_core_post_429_json_resp}},
        {500, {Generate, :v2beta_stable_image_generate_core_post_500_json_resp}}
      ],
      opts: opts
    })
  end

  @type v2beta_stable_image_generate_sd3_post_400_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }

  @type v2beta_stable_image_generate_sd3_post_413_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }

  @type v2beta_stable_image_generate_sd3_post_422_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }

  @type v2beta_stable_image_generate_sd3_post_429_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }

  @type v2beta_stable_image_generate_sd3_post_500_json_resp :: %{
          errors: [String.t()],
          id: String.t(),
          name: String.t()
        }
  ...
  """
  @spec v2beta_stable_image_generate_sd3_post(ImageToImage.t() | TextToImage.t(), keyword) ::
          {:ok, map | String.t()} | {:error, map | ContentModerationResponse.t()}
  def v2beta_stable_image_generate_sd3_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Generate, :v2beta_stable_image_generate_sd3_post},
      ...
      response: [
        {200,
         {:union,
          [{Generate, :v2beta_stable_image_generate_sd3_post_200__resp}, string: :generic]}},
        {400, {Generate, :v2beta_stable_image_generate_sd3_post_400_json_resp}},
        {403, {ContentModerationResponse, :t}},
        {413, {Generate, :v2beta_stable_image_generate_sd3_post_413_json_resp}},
        {422, {Generate, :v2beta_stable_image_generate_sd3_post_422_json_resp}},
        {429, {Generate, :v2beta_stable_image_generate_sd3_post_429_json_resp}},
        {500, {Generate, :v2beta_stable_image_generate_sd3_post_500_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  def __fields__(:v2beta_stable_image_generate_core_post_200__resp) do
    [
  ...
  def __fields__(:v2beta_stable_image_generate_core_post_400_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_core_post_422_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_core_post_429_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_core_post_500_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_sd3_post_200__resp) do
    [
      finish_reason: {:enum, ["SUCCESS", "CONTENT_FILTERED"]},
      image: {:string, :generic},
      seed: :number
  ...
  def __fields__(:v2beta_stable_image_generate_sd3_post_400_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_sd3_post_413_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_sd3_post_422_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_sd3_post_429_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end

  def __fields__(:v2beta_stable_image_generate_sd3_post_500_json_resp) do
    [errors: [string: :generic], id: {:string, :generic}, name: {:string, :generic}]
  end
end
